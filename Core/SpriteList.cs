...
namespace SunbirdMB.Core
{
    ...
    {   
        ...
        /// </summary>
        public HashSet<Coord2D> OccupiedCoords { get; set; } = new HashSet<Coord2D>();
        ...
        {
            XmlSerializer occupiedCoordsSerializer = new XmlSerializer(typeof(HashSet<Coord2D>));
            ...
            while (reader.NodeType != XmlNodeType.EndElement)
            {
                ...
                else if (reader.Name == "OccupiedCoords")
                {
                    ...
                    OccupiedCoords = (HashSet<Coord2D>)occupiedCoordsSerializer.Deserialize(reader);
                    reader.ReadEndElement();
                }
